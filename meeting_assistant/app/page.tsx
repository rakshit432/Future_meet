...
import { Video, Mic, Shield, Users, ArrowRight, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute -top-[10%] -left-[10%] w-[60%] md:w-[40%] h-[60%] md:h-[40%] bg-indigo-600/20 rounded-full blur-[120px]"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute -bottom-[10%] -right-[10%] w-[70%] md:w-[50%] h-[70%] md:h-[50%] bg-cyan-600/20 rounded-full blur-[150px]"
        />
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            {[
              ...
              { icon: Users, label: "Collaborative", color: "text-cyan-400" },
          ...
          <div className="relative bg-[#0F1115]/80 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-6 md:p-8 lg:p-10 shadow-2xl">
            <div className="space-y-5 md:space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-400 text-sm">Enter your name to step into the room</p>
              </div>
